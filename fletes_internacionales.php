            ...
            while ($via_actual < $reporte_cant_vias) {    // ----------------------------------------------------------------      WHILE DE VIAS               --------------------------------------------------------------
                ...
                if ($resultados_busqueda_estandar = $conexion_bd->query($sent_buscar)) {
                    ...
                    while ($filas_resultado_estandar = $resultados_busqueda_estandar->fetch_assoc()) {    // obtener array asociativo 
                        ...
                        $pdf->Cell(22, $alto_renglon_celda, utf8_decode($texto), $bordes, $siguiente_linea, $alineacion, $rellenar);
                        ...
                        $texto = substr($filas_resultado_estandar['lugar_embarque'], 0, 15); //Ad. de salida
                        ...
                        $texto = substr($filas_resultado_estandar['descripcion_producto'], 0 ,25); //Producto
